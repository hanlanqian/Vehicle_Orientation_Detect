...
if __name__ == '__main__':
    ...
    scaled_overhead_hmatrix1 = get_scaled_matrix(overhead_hmatrix, target_shape, est_range_u, est_range_v,
                                                 strict=strict)
    scaled_overhead_hmatrix1 = convertToBirdView(K, rotation, (width, height), target_shape, strict)



    # test1 = scaled_overhead_hmatrix1/scaled_overhead_hmatrix1[-1, -1]
    # diff = scaled_overhead_hmatrix2 - test1
    # print(diff/scaled_overhead_hmatrix2)

    # path = '../calibration.jpg'
    # img = cv2.imread(path)
    # img = cv2.resize(img, (-1, -1), fx=2, fy=2)
